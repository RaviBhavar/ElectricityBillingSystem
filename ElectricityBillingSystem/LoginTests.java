...
class LoginTests {
	...
	@Test
	void addLoginTest() {
		LoginEntity LoginEntity = new LoginEntity("ravi@gmail.com", "iamfull", "admin");
	...
	void getLoginTest() {
		...
		try {
			result = loginServiceImple.getLogin("ravi@gmail.com");
	...
	void updateLoginTest() {
		LoginEntity LoginEntity = new LoginEntity("ravi@gmail.com", "iamnotfull", "admin");
		LoginEntity result = null;
		try {
			result = loginServiceImple.updateLogin("ravi@gmail.com", LoginEntity);
			if(result==null)
	...
	void removeLoginTest() {
		...
		try {
			result = loginServiceImple.deleteLogin("ravi@gmail.com");
			if(result==null)
				throw  new LoginNotFoundException("no login found");
			assertEquals(LoginEntity.toString(), result.get().toString());
		} catch (LoginNotFoundException e) {
